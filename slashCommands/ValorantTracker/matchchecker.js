...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName("valomatch")
        .setDescription("Check a valorant match")
        .addStringOption(option => option.setName('matchid').setDescription('The id of the match you want to look up').setRequired(true)),
    ...
    interaction.deferReply({ content: "Getting data." }).then(async () => {
        ...
        try {
            ...
            if (MatchData.metadata.mode == "Deathmatch") { return interaction.editReply({ content: "This mode is currently not supported", ephemeral: true }) }
            ...
            interaction.editReply({files: [finalcanvas.toBuffer()]})
